@extends('admin.layouts.app',['title'=>'Manage Plan','sub_title'=>'Create'])
...
<div class="container-fluid">
    <div class="card shadow mb-4 mt-3">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 text-primary">Add New Plan</h5>
        </div>
        <div class="card-body">
            <form id="create-form" action="{{route('admin.plan.store')}}" method="post">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            <label for="no_of_user" class="form-label">No. of Logins<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="no_of_user" name="no_of_user" oninput="this.value=this.value.replace(/[^0-9]/g, '').slice(0, 5)" maxlength="5">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="price" name="price" oninput="this.value=this.value.replace(/[^0-9]/g, '').slice(0, 20)">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <label class="radio-inline mr-3"><input type="radio" name="status" value="1" checked=""> Active</label>
                                <label class="radio-inline mr-3"><input type="radio" name="status" value="2"> Inactive</label>
