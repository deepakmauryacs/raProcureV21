...
<body>
    <div class="table-border" style="border: 1px solid #000;">
        ...
        <?php 
            $totalval=0;
            $starting_state_code = substr($buyer->gstin,0,2);
        ?>
            ...
            <tbody>
                <tr>
                    <td style="padding: 15px;width: 50%;  border-right: 1px solid #000; border-bottom: 1px solid #000;" colspan="5">
                        ...
                        <p class="fc"><b>Customer Name :{{$buyer->legal_name}}</b></p>
                        <p class="fc"><b>Customer Code : </b>{{$buyer->buyer_code}}</p>
                        <p class="fc"><b>GSTIN : </b>{{$buyer->gstin}}</p>
                        <p class="fc"><b>PAN : </b>{{$buyer->pan}}</p>
                    </td>
                    <td style="padding: 15px;width: 50%;  border-bottom: 1px solid #000;" colspan="8">
                        <p class="fc"><b>Address : </b> {{$buyer->registered_address}}</p>   
                        <p class="fc"><b>State : </b>{{getCityStateCountry($buyer->state,'state')}}</p>
                        <p class="fc"><b>State Code : </b> {{$starting_state_code}}</p>
                        <p class="fc"><b>Place of Supply : </b> {{getCityStateCountry($buyer->city,'city')}},{{getCityStateCountry($buyer->state,'state')}}</p>
                    </td>
                </tr>
            </tbody>
        </table>
