@extends('admin.layouts.app', ['title' => 'Products for Approval', 'sub_title' => 'Approval List'])
@section('content')
<style>
...
<div class="container-fluid">
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Products for Approval</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.product-approvals.index') }}" class="btn btn-secondary ml-2">RESET</a>
                        </div>
                    </div>
                </div>
            </form>
