@extends('admin.layouts.app', ['title' => 'Edit Product Request', 'sub_title' => 'Edit Product List'])
@section('content')
<style>
...
<div class="container-fluid">
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Edit Product Request</h6>
        </div>
        <div class="card-body">
            <form id="searchForm" action="{{ route('admin.edit-products.index') }}" method="GET">
                <div class="row mb-4">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.edit-products.index') }}" class="btn btn-secondary ml-2">RESET</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="table-responsive" id="table-container">
                @include('admin.edit-product-requests.partials.table', ['products' => $products])
            </div>
        </div>
    </div>
</div>
