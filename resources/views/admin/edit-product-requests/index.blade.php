@extends('admin.layouts.app_second', ['title' => 'Edit Product Request', 'sub_title' => 'Edit Product List'])
        ...
        <div class="card border-0">
            <div class="card-body">
                <div class="col-md-12 botom-border">
                    <h3 class="">Edit Product Request</h3>
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <form id="searchForm" action="{{ route('admin.edit-products.index') }}" method="GET">
                                <ul class="rfq-filter-button">
                                    ...
                                    <li class="notShow_on_mobile">
                                        <a href="{{ route('admin.edit-products.index') }}" class="btn-style btn-style-danger">RESET</a>
                                    </li>
                                </ul>
                            </form>
                        </div>
