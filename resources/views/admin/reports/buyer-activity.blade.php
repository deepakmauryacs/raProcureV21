        ...
        <div class="card border-0">
            <div class="card-body">
                <div class="col-md-12 botom-border">
                    <h3 class="">Buyer Activity Reports</h3>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="table-responsive product_listing_table_wrap" id="table-container">
                        @include('admin.reports.partials.buyer-activity-table', ['results' => $results])
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        const exporter = new Exporter({
            ...
            headers: ["Name Of Buyer", "Primary Contact", "Phone No", "Email", "No. of Accounts Created", "Total RFQ Generated", "Total Bulk RFQ Generated","Total Offers Received","Total Orders Confirmed","Value (Of Confirmed Orders)","Last Login Date"],
