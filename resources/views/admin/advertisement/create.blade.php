@extends('admin.layouts.app_second', [
    ...
    'sub_title' => 'Create Advertisement',
])
...
<div class="breadcrumb-header">
    <div class="container-fluid">
        <h5 class="breadcrumb-line">
            ...
            <a href="{{ route('admin.advertisement.index') }}"> -> Advertisement List</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form pro_edit">
                            <form id="createAdvertisementForm" class="form-horizontal form-material">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="buyer_vendor_name" name="buyer_vendor_name" oninput="limitCharacters(this,255)">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="payment_received_on" name="payment_received_on">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="date" class="form-control" id="validity_period_from" name="validity_period_from" onblur="set_to_date();">
                                                <span class="text-danger error-text validity_period_from_error"></span>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="date" class="form-control" id="validity_period_to" name="validity_period_to">
                                                <span class="text-danger error-text validity_period_to_error"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="images" class="form-label"><strong>Image Upload</strong> <span class="text-danger">*</span></label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" id="ad_position" name="ad_position">
                                            ...
                                            <option value="1">Buyer Ads only on the Vendor Side</option>
                                            <option value="2">Vendor Ads only on the Buyer Side</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="ads_url" name="ads_url" oninput="limitCharacters(this,255)">
...
$(document).ready(function () {
    ...
    $('#createAdvertisementForm input, #createAdvertisementForm select').on('keyup change', function() {
        const fieldName = $(this).attr('name');
        $(`span.error-text.${fieldName}_error`).text('');
    });

    // Form submission
    $('#createAdvertisementForm').submit(function (e) {
        e.preventDefault();
