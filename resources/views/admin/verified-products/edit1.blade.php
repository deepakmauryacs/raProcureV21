...
<div class="container-fluid">
    <div class="card shadow mb-4 mt-3">
        ...
        <div class="card-body">
            <form id="editVerifiedProductForm">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.verified-products.index') }}" class="btn btn-secondary me-2">Cancel</a>
...
$(document).ready(function () {
    ...
    $('#editVerifiedProductForm').submit(function (e) {
        ...
        if (!product_hsn_code) {
            ...
            hasErrors = true;
        } else if (!/^\d{4,8}$/.test(product_hsn_code)) {
            $('#product_hsn_code_error').text('HSN code must be 4 to 8 digits.');
            hasErrors = true;
        }
...
function validateProductFile(fileInput, allowedExtensions) {
    ...
    // Additional validation checks can be added here (e.g., file size)
    // if (file.size > 5 * 1024 * 1024) { // 5MB limit example
    //     showToastError('File size too large. Maximum 5MB allowed.');
    //     fileInput.value = '';
    //     return false;
    // }
