    ...
    return `<tr data-index="${index}">
        ...
        <td>
            <div class="simple-file-upload">
                <input type="file" name="products[${rowCount}][image]" id="uploadFile_${rowCount}" class="real-file-input" style="display: none;" accept="image/jpeg,image/jpg,image/png,image/gif">
