@extends('vendor.layouts.app_second',['title'=>'Orders Confirmed','sub_title'=>'RFQs Order'])
@section('css')
...
<div class="breadcrumb-header">
    <div class="container-fluid">
        <h5 class="breadcrumb-line">
            ...
            <a href="{{ route('vendor.rfq_order.index') }}"> ->RFQs Order</a>
        </h5>
    </div>
</div>
@endsection
    ...
    <section class="manage-product card">
        <div class="card">
            <div class="card-header bg-white py-3">
                <h1 class="card-title font-size-18 mb-0">RFQs Order</h1>
                <!-- Search Section -->
                <form id="searchForm" action="{{ route('vendor.rfq_order.index') }}" method="GET">
                    <div class="row align-items-center flex-wrap flex-wrap gx-3 gy-4 pt-3">
                        <div class="col-12 col-sm-6 col-md-auto">
                            <div class="input-group generate-rfq-input-group">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="rfq_no" name="rfq_no" placeholder="RFQ No"  value="{{ request('rfq_no') }}">
                            ...
                            <div class="input-group generate-rfq-input-group">
                                ...
                                <div class="form-floating">
                                    <select name="status" id="status" class="form-select cw-200">
                                        ...
                                        <option value="3" {{ request('status') == '3' ? 'selected' : '' }}>Confirmed</option>
                        ...
                        <div class="col-12 col-sm-6 col-md-auto">
                            <div class="d-flex align-item-center gap-3">
                                ...
                                <a href="{{ route('vendor.rfq_order.index') }}" class="ra-btn ra-btn-outline-danger">
            ...
            <div class="card-body add-product-section">
                <div class="table-responsive" id="table-container">
                     @include('vendor.order.partials.rfq-table', ['results' => $results])
                </div>
            </div>
        </div>
    </section>
...
function uploadPIFile(obj) {
    ...
    $.ajax({
        type: "POST",
        url: 'https://tech.guruworkwithit.online/sysadmin/orders/uploadVendorOrderPI',
        dataType: 'json',
        data: formData,
        contentType: false,
        cache: false,
