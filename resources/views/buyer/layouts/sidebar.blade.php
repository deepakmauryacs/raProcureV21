        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
            <div class="accordion-body">
                <ul class="accordian-submenu">
                    ...
                    <li><a href="{{ route("buyer.rfq.active-rfq") }}">Active RFQs / CIS</a></li>
                    <li><a href="javascript:void(0)">Auction</a></li>
                    <li><a href="{{ route("buyer.rfq.draft-rfq") }}">Draft RFQ</a></li>
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
            <div class="accordion-body">
                <ul class="accordian-submenu" aria-labelledby="headingTwo">
                    <li><a href="{{ route("buyer.profile") }}">My Profile</a></li>
