                        ...
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <span class="text-dark">Logo (File Type: JPG,JPEG,PNG)</span>
                                ...
                                <div class="col-xl-6 -lg-6 col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 buyer-pan-card-upload-field">
                                            <input type="hidden" name="pan_file_old" value="{{ $buyer->pan_file }}" >
                                            <span class="text-dark">(File Type: JPG, JPEG, PDF)
                                                <span class="text-danger">* </span>
                                            </span>
                                            <div class="file-browse">
                                                <span class="button button-browse">
                            ...
                            <div class="row mt-4 justify-content-between">
                                ...
                                <div class="col-md-6 col-sm-6 col-12">
                                    <button href="javascript:void(0)" type="button"
                                        class="btn-rfq btn-rfq-secondary ms-auto d-table"
                            ...
                            <div id="branch_container">
                                    ...
                                    @foreach ($branchDetails as $k => $branch)
                                        <div class="row branch-row" data-row-id="{{ $k }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select division-sumo-select required" name="branch_categories[{{ $k }}][]" multiple>
                                                    @php
                                ...
                                @else
                                    <div class="row branch-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Division<span class="text-danger">*</span></label>
                                            <select class="form-select division-sumo-select required" name="branch_categories[0][]" multiple>
                                                @if(!empty($divisions))
                                                    @foreach ($divisions as $id => $division_name)
